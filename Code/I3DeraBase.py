...
def load_model():
    ...
    saver.restore(sess, tf.compat.v1.train.latest_checkpoint('./model_I3D-Kinetics'))
...
def infer_video(video_file, sess, input_tensor, output_tensor, writer):
...
def main():
    ...
    csv_file_path = "predictionsI3DKineticsBase.csv"
    ...
    with open(csv_file_path, mode='w', newline='') as csv_file:
        ...
        for video_file in video_files_list:
            infer_video(video_file, sess, input_tensor, output_tensor, writer)
