...
transform = transforms.Compose([
    ...
    transforms.Resize((299, 299)),  # Resize to input size of InceptionV3
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
])

# Opening of CSV file and writing tested data
with open('predictionsTRNSMomentsVar2.csv', 'w', newline='') as csvfile:
    ...
    for video_name in video_names:
        ...
        # Initializing of frame count, temporal sequence for aggregation and number of frames for aggregation
        frame_count = 0
        temporal_sequence = []
        sequence_length = 5
